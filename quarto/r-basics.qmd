...
The code below - if corrected - *would* (on our server or in standalone R) run without an error and read in some baseball statistics from the file <http://stacyderuiter.github.io/teachingdata/data-raw/baseball.csv>. 
